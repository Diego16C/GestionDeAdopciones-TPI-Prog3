...
const NewShelters = ({ onShelterAdded, shelterToEdit, onCancel }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (isEdit) {
            ...
            onShelterAdded(savedShelter, 'Refugio actualizado correctamente ✅');
        } else {
            savedShelter = await createShelter(shelterData);
            onShelterAdded(savedShelter, 'Refugio agregado correctamente ✅');
            // Limpiar campos
            setName('');
            setAddress('');
            setEmail('');
        ...
        onShelterAdded(null, 'Error guardando refugio ❌');
        }
    };
